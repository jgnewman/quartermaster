...
const Tiles = forwardRef(function (props, ref) {
    return (React.createElement(IconWrapper, Object.assign({}, props, { disableStroke: true, ref: ref, title: props.title || "Tiles icon" }),
        React.createElement("path", { className: "qmPathIsFilled", d: tile1 }),
        React.createElement("path", { className: "qmPathIsFilled", d: tile2 }),
        React.createElement("path", { className: "qmPathIsFilled", d: tile3 }),
        React.createElement("path", { className: "qmPathIsFilled", d: tile4 })));
});
