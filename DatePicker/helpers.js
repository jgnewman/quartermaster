...
export function decrementMonth(referenceDateStamp) {
...
export function incrementMonth(referenceDateStamp) {
    const date = new Date(referenceDateStamp);
    const month = date.getMonth();
    const year = date.getFullYear();
    if (month === 11) {
...
export function getCalendarDataForMonth(referenceDateStamp, disablePast) {
    const now = new Date();
...
export function getHoursForDay(dateStamp, increment) {
