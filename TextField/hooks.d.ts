...
export declare function useChangeHandler(type: string | undefined, changeHandler: ChangeEventHandler | undefined, inputRef: RefObject<HTMLInputElement | HTMLTextAreaElement>, shouldPreventInput: ReturnType<typeof usePreventInputDecision>): (evt: ChangeEvent<Element>) => void;
export declare function useKeyUpHandler(keyUpHandler: KeyboardEventHandler | undefined, shouldPreventInput: ReturnType<typeof usePreventInputDecision>): (evt: KeyboardEvent<Element>) => void;
