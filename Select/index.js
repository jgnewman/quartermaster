...
import { useRefArray, } from "../lib/hooks";
...
function Select({ changeHandler, className, id, isCompact = false, isDisabled = false, isRequired = false, label, options, placeholder = "Select...", position = "bottom", value, }) {
    ...
    return (React.createElement("div", { className: `qmSelectContainer ${containerClasses} ${className || ""}` },
        ...
        React.createElement("div", { className: "qmSelectContentWrapper", ref: wrapperRef },
            React.createElement("div", Object.assign({ className: `qmSelectClickableWrapper ${clickableWrapperClasses}`, role: "button", tabIndex: 0, onFocus: handleFocusSelect, onBlur: handleBlurSelect, onKeyDown: handleKeyDownSelect }, clickableWrapperProps),
                ...
                hasSelectedValue && (React.createElement("button", { className: `qmSelectClearIconWrapper ${buttonClasses}`, onClick: handleClickClearButton, onFocus: handleFocusClearButton },
