...
export declare function useKeyDownHandler(value: string | null, currentOptions: RefArray<HTMLSpanElement>): (evt: KeyboardEvent) => void;
export declare function useClickOptionHandler(selectValue: ValueSelector): (evt: MouseEvent) => void;
...
export declare function useOptionKeyDownHandler(focusSiblingOption: SiblingOptionFocuser, selectValue: ValueSelector): (evt: KeyboardEvent) => void;
...
export declare function useClearButtonFocuser(): (evt: FocusEvent) => void;
