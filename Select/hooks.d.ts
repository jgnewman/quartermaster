...
import { RefArray } from "../lib/hooks";
...
export declare function useFocusHandler(setIsFocused: Dispatch<SetStateAction<boolean>>, setIsOpen: Dispatch<SetStateAction<boolean>>): () => void;
