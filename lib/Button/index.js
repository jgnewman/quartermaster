...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        var _a = this.props, children = _a.children, tag = _a.tag, text = _a.text, className = _a.className, isDisabled = _a.isDisabled, isProcessing = _a.isProcessing, clickHandler = _a.clickHandler;
